...
df = pd.read_csv(f'parsedOutput/df_parsed_output_text_chatgpt_3.5_turbo_hf_{args.dataset}_wo_finetune_exp1.csv')
...
# Map stance labels to numeric values
